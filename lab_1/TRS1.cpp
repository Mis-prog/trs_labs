...
void task1() {
    ...
    for (int i = 0; i < n.size(); i++) {
        ofstream file_to_cout_V("z1_v" + to_string(n[i]) + ".txt");
        ofstream file_to_cout_X("z1_x" + to_string(n[i]) + ".txt");
...
void task2() {
    ...
    for (int i = 0; i < n.size(); i++) {
        ofstream file_to_cout_V("z2_v" + to_string(n[i]) + ".txt");
        ofstream file_to_cout_X("z2_x" + to_string(n[i]) + ".txt");
...
void task3() {
    ...
    for (int i = 0; i < n.size(); i++) {
        ofstream file_to_cout_V("z3_v" + to_string(n[i]) + ".txt");
        ofstream file_to_cout_X("z3_x" + to_string(n[i]) + ".txt");
        v_prev = 0.09, x_prev = 0;
        v_next = 0, x_next = 0;
